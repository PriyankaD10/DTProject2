...
<title>NIIT Tech Tree</title>
<!-- CSS -->
<link rel="stylesheet"
	href="https://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,600">
...
<link rel="apple-touch-icon-precomposed"
	...
	<script
	src="resources/assets/js/scripts.js"></script>
	<script
	src="resources/assets/js/placeholder.js"></script>
	<script
	src="resources/assets/js/wow.min.js"></script>
<script
	src="resources/assets/js/waypoints.js"></script>
<script
	src="resources/assets/js/retina-1.1.0.min.js"></script>
<script
	src="resources/assets/js/jquery-1.11.1.min.js"></script>
<script
	src="resources/assets/js/jquery.backstrech.min.js"></script>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                        	<div class="logo wow fadeInDown" style="background-color:#c9ede4">
                        		<a href="/resources/assets/index.html"></a>
                        	</div>
                        	<br><br><br>
                            <center><h1 class="wow fadeInLeftBig">NIIT Tech Tree</h1></center>
                            <div class="description wow fadeInLeftBig">
                            	<p>
	                            	A one-stop portal for all NIIT Students of India. Become a part of the virtual community of NIIT Student
                            	</p>
                            </div>
